  ...
  return (
    <div
      className={cn(
        ...
        active
          ? 'border-primary/70 shadow-[0_0_0_1px_rgba(193,39,45,0.25)] text-foreground'
          : 'border-neutral-800 hover:border-border text-foreground'
      )}
    >
  ...
  return (
    <div className="space-y-4">
      ...
      <section>
        ...
        <div className="glass-card-elevated bg-neutral-900 rounded-[8px] p-4 md:p-5">
