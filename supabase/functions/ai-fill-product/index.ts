...
- part_type: para MOTOS especificamente — NGK e Denso são OEM de velas (Honda, Yamaha, Suzuki, Kawasaki usam NGK/Denso de fábrica). Bosch é OEM de vela para CARROS, não para motos — se for vela Bosch para moto = "paralela". Brembo, EBC são OEM de freio. Mahle, Mann, Fram são OEM de filtro. Motul, Castrol, Shell, Mobil são OEM de óleo. DID (Daido) e RK são OEM de corrente e kit de transmissão para motos (Honda, Yamaha, Suzuki, Kawasaki usam DID/RK de fábrica) → "original". Yamaha, Honda, Suzuki, Kawasaki (peças genuínas com nome da montadora) → "original". Palavras "paralela", "genérica", "universal", "similar", "compatível" → "paralela". "Usada", "seminova" → "usada". Sem informação → null
